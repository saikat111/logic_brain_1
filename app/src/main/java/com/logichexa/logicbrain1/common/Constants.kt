...
object Constants {
    ...
    const val API_KEY = "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"

    const val REWARDED_AD_UNIT_ID =
        "ca-app-pub-9312766620009008/2310031893"

    const val PRIVACY_POLICY = "https://privacypolicyalrakibsorder.blogspot.com/p/privacy-policy-for-logic-brain-10.html"
    ...
    const val YEARLY_BASE_PLAN = "logicbrain1-pro-year"
